...
@section('content')
    <div class="rounded-lg bg-gray-800 p-3 pointer-events-none min-w-full min-h-full">
        @switch($form->currentScreen)
            @case(\App\Livewire\Forms\CurrentScreen::Auth)
                <div class="leading-[0] grid grid-cols-2 gap-x-2 justify-stretch  min-h-full">
                    <div class="group">
                        ...
                        <input type="image" class="group-hover:blur-sm transition-[filter] hover:bg-gray-700 border rounded-lg shadow bg-gray-800 border-gray-700 font-normal text-gray-400 {{$selected ? "pointer-events-none" : "pointer-events-auto"}}" width="64" height="64" wire:click="$set('form.currentScreen', 1)" src="images/register.svg" alt="Register"/>
                    </div>
                    <div class="group">
                        ...
                        <input type="image" class="group-hover:blur-sm transition-[filter] hover:bg-gray-700 border rounded-lg shadow bg-gray-800 border-gray-700 font-normal text-gray-400 {{$selected ? "pointer-events-none" : "pointer-events-auto"}}" width="64" height="64" wire:click="$set('form.currentScreen', 2)" src="images/login-in.svg" alt="Login"/>
                    </div>
                </div>
                @break
            @case(\App\Livewire\Forms\CurrentScreen::Register)
                ...
                <form class="grid pointer-events-none min-w-full min-h-full " wire:submit="register">
                    ...
                    <button class="my-2 p-2 px-3 justify-self-end border rounded-lg shadow border-gray-700 bg-gray-800 hover:bg-gray-700 font-normal text-gray-400 pointer-events-auto" type="submit">Register</button>
            ...
            @case(\App\Livewire\Forms\CurrentScreen::Login)
                ...
                <form class="grid pointer-events-none" wire:submit="login">
                    ...
                    <label class="pl-1 p-2 font-normal text-gray-400 pointer-events-auto max-w-fit" for="password">Password:</label>
                    <input class="font-normal text-gray-400 bg-gray-700 rounded-lg shadow p-1 pointer-events-auto" type="password" wire:model.change="form.password" name="password" id="password">
                    <button class="my-2 p-2 px-3 justify-self-end  border rounded-lg shadow bg-gray-800 border-gray-700 hover:bg-gray-700 font-normal text-gray-400 pointer-events-auto" type="submit">Login</button>
